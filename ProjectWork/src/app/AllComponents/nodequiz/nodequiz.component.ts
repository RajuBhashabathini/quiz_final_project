...
@Component({
  selector: 'app-nodequiz',
  templateUrl: './nodequiz.component.html',
  styleUrls: ['./nodequiz.component.css']
})
export class NodequizComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.call.getNodeQuestions().subscribe((res) => {
