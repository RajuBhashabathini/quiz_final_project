...
@Component({
  selector: 'app-gitquiz',
  templateUrl: './gitquiz.component.html',
  styleUrls: ['./gitquiz.component.css']
})
export class GitquizComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.call.getGITQuestions().subscribe((res) => {
