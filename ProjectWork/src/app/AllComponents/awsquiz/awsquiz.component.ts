...
@Component({
  selector: 'app-awsquiz',
  templateUrl: './awsquiz.component.html',
  styleUrls: ['./awsquiz.component.css']
})
export class AwsquizComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.call.getAWSQuestions().subscribe((res) => {
